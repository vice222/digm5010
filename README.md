## Week 10
This project is inspired by the paper "Seeing around corners: Cells solve mazes and respond at a distance using attractant breakdown" published earlier this year. By observing the migration of neutrophils cells for engulfing bacteria of infection, Tweedy et al. have found the cells’ ability to navigate a complex path or solve a maze based on the self-generated chemotaxis. After filling the routes with attractant fluid, they let cells navigate and break down the fluid near them. The fluid from nearby high concentration areas will soon diffuse toward them; thus, the gradient is generated by the interplay between cells and the environment. The cells will sense and acquire the surrounding information about the environment and be headed toward the high concentration point where is the destination according to the gradients of attractant. My project aims to re-implement this new research finding from the simulator and perhaps explore more beyond it. 
